"use client"
//مناسب برای انتخاب یک مقدار واحد (مثلاً مقدار صدا، روشنایی) فقط یک مقدار
import * as React from "react"
import * as SliderPrimitive from "@radix-ui/react-slider"

import { cn } from "@/lib/utils"

// کامپوننت اسلایدر: برای انتخاب مقادیر از بین یک بازه با استفاده از کشیدن
...
// صادر کردن کامپوننت Slider برای استفاده در سایر قسمت‌ها
export { Slider }

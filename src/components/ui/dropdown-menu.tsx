...
// دکمه فعال‌سازی منوی کشویی
const DropdownMenuTrigger = DropdownMenuPrimitive.Trigger
// گروه‌های منوی کشویی (برای سازماندهی آیتم‌ها)
const DropdownMenuGroup = DropdownMenuPrimitive.Group
// پورتال برای منوی کشویی (برای نمایش در سطح بالاتر)
const DropdownMenuPortal = DropdownMenuPrimitive.Portal
// زیرمنوهای کشویی
const DropdownMenuSub = DropdownMenuPrimitive.Sub
// گروه رادیویی برای انتخاب تنها یک آیتم از مجموعه
const DropdownMenuRadioGroup = DropdownMenuPrimitive.RadioGroup


// کامپوننت SubTrigger برای زیرمنوهای کشویی
...
// کامپوننت SubContent برای محتویات زیرمنو
...
DropdownMenuSubContent.displayName =
  ...
  // کامپوننت Content برای محتویات منوی اصلی
...
// میانبرهای منو (برای نمایش میانبرها در آیتم‌ها)

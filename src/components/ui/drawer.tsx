...
const Drawer = ({
  shouldScaleBackground = true,// آیا پس‌زمینه هنگام باز شدن کشو تار شود؟
  ...props
...
// تریگر برای باز کردن کشو
const DrawerTrigger = DrawerPrimitive.Trigger
// Portal برای نمایش کشو خارج از ساختار DOM فعلی
const DrawerPortal = DrawerPrimitive.Portal
// دکمه بستن کشو
const DrawerClose = DrawerPrimitive.Close
// Overlay (پوشش تیره پشت کشو)
...
// هدر کشو - معمولاً عنوان یا توضیح کوتاه
const DrawerHeader = ({
  className,
  ...props
...
// فوتر کشو - برای دکمه‌ها مثل تایید یا بستن
const DrawerFooter = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (

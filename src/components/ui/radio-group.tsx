...
// کامپوننت اصلی گروه دکمه‌های رادیویی
...
>(({ className, ...props }, ref) => {
  return (
    ...
    dir="rtl"
      className={cn("grid gap-2 rtl", className)}
      {...props}
      ref={ref}
    />
  );
...
// کامپوننت آیتم‌های رادیوگروه (هر دکمه جداگانه)
  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator className="flex items-center justify-center">
        <Icon icon={"material-symbols:radio-button-checked"} className="h-full w-full    text-secondary-500" />

...
// ریشه کامپوننت Select
const Select = SelectPrimitive.Root

// گروه‌بندی آیتم‌ها در منوی انتخاب
const SelectGroup = SelectPrimitive.Group

// نمایشی از مقدار انتخابی
...
>(({ className, children, ...props }, ref) => (
  ...
  ref={ref}
  className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm ring-offset-white data-[placeholder]:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:data-[placeholder]:text-neutral-400 dark:focus:ring-neutral-300",
      className
  )}
  {...props}
>
...
// لیست گزینه‌ها که هنگام باز شدن نمایش داده می‌شود.
